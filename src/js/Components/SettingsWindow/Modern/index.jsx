...
export default function ModernSettings() {
	...
	const handleDragStop = (_, dragData) => {
		const bounds = getBounds();
	...
	// Determine if evoker button should be visible
	...
	return (
		<>
			{/* Settings Evoker Button - show or show on hover */}
			{evokerVisible && (
				<button
					type="button"
				...
				>
					<span
						className={cn(
							...
							"glass",
							// Show on hover mode - fade in/out
								...
								<div className="flex items-center gap-3">
									...
									<div>
										...
										<p className="text-xs text-muted-foreground">
											{data.get(lang, "settings.subtitle") ||
												"Customize your greeter"}
										</p>
									</div>
								</div>
